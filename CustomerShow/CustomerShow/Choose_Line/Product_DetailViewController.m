//
//  Product_DetailViewController.m
//  Icicle
//
...
@interface Product_DetailViewController ()

@end

@implementation Product_DetailViewController
@synthesize scroll;
...
-(void)initImage:(int)number
{
    ...
    for (int M=0; M < num11; M++) {
        ...
        for (int i=0; i < num22; i++) {
            ...
            NSString *imgPaths = [NSString stringWithFormat:@"s_%@",[[arryImages objectAtIndex:i] objectForKey:@"img"]];
...
-(void)ceBianLan{
    ...
    view = [[UIView alloc]initWithFrame:CGRectMake(1024-29 , 0, 152, 768)];
...
- (void)OpenCe
{
    ...
    {
        [view setFrame:CGRectMake(1024-29, 0, 158, 768)];
        [scroll setContentOffset:CGPointMake(0+1024*m, 0) animated:NO];
        zheZhaoview.hidden=YES;
    }
    yet = !yet;
